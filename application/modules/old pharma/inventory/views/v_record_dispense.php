        ...
        <div class="right_col" role="main">
          <div class="">
              ...
              <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="row filter">
                   ...
                   <div class="form-group col-xs-12" id="filter_col2" data-column="1" <?php if ($this->session->userdata('profile') == 'user') { echo "style='display:none'"; } ?>>
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
              <div class="x_panel">
                <div class="x_content">
                  <table class="cell-border compact hover width-full" id="dt_dispense_record" cellspacing="0" width="100%">
                   <thead>
                    <tr>
                     <th width="20%" style="min-width:70px;">RIS NO</th>
                     <th width="">SOURCE</th>
                     <th width="" style="min-width:250px;">DESTINATION</th>
                     <th width="">FUND</th>
                     <th width="" style="min-width:200px;">PROGRAM</th>
                   </tr>
                 </thead>
               </table>
             </div>
              ...
              <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-9 col-sm-9 col-xs-6">
                    <label><strong>Brgy:</strong></label>
                    <p class="form-control input-sm"></p>
                  </div>
                </div>
                <div class="row">

  ...
  <div class="">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <center><h2>SOLO PARENT LIST</h2></center>
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <form id="frm_filter_soloparent" name="frm_filter_soloparent">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                  <!-- <div class="actionBar"> -->
                    ...
                    <button type="button" class="buttonNext btn btn-success input-sm col-lg-12 col-md-12 col-sm-12 col-xs-12" id="btn_soloparentsearch"><i class="fa fa-filter"></i> Filter</button>
                  <!-- </div> -->
                  <!-- <label class="control-label"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</label> -->
                </div>
              </form>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <hr>
              <table class="cell-border compact hover width-full" id="dt_soloparentlist" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    <th style="min-width: 200px">FULL NAME</th>
                    <th>Gender</th>
                    <th>AGE</th>
                    <th style="min-width: 80px">BIRTH DATE</th>
                    <th>CIVIL STATUS</th>
                    <th>LOT/BLK</th>
                    <th>STREET</th>
                    <th>SUBDIVISION</th>
    ...
    <!-- <div class="row"> -->
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <form id="frm_soloparentservices" name="frm_soloparentservices">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <label class="control-label"> Name <input type="hidden" id="masterid" name="masterid"></label>
            ...
            <div class="col-lg-2 col-md-6 col-sm-12 col-xs-12">
              <label class="control-label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
              <button type="button" class="btn btn-primary col-lg-12 col-md-12 col-sm-12 col-xs-12 input-sm" id="btn_tagsoloparentservice"><i class="fa fa-tag"></i> Mark</button>
            </div>
          </form>
          </div>
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <table class="cell-border compact hover width-full" id="dt_serviceavailed" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th>FULL NAME</th>
                  <th style="min-width: 150px">SECTOR</th>
                  <th style="min-width: 200px">SERVICE</th>
                  <th style="width: 90px">DATE AVAILED</th>
                </tr>
              </thead>
            </table>
          </div>

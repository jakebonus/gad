        ...
        <div class="x_content">
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <form id="frm_info"  autocomplete="off" novalidate="novalidate" class="fv-form fv-form-bootstrap">
                ...
                <div class="form-group col-xs-6">
                  <label class="control-label">SOLO PARENT Number</label>
                  <input type="text" class="form-control input-sm" id="soloparentnum" name="soloparentnum" readonly>
                </div>
                <div class="form-group col-xs-6">
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <!-- <center> <h5>- Other Information  -</h5></center> -->
            <!-- <hr> -->
            <form id="frm_otherinfo" name="frm_otherinfo">
              <div class="form-group col-xs-6">
                <label class="control-label">Sector Services</label>
                <!-- <select multiple class="form-control input-sm" id="sectortag" name="sectortag"> -->
                <select class="form-control input-sm" id="sectortag" name="sectortag">
                 <option value="">- - -</option>
                 <option value="SOLO PARENT">SOLO PARENT</option>
                 <option value="PWD">PWD</option>
               </select>
              ...
              <div class="form-group col-xs-6">
                ...
                <select class="form-control input-sm" id="specify" name="specify">
                 <option value="">- - -</option>
               </select>
              ...
              <!-- <div class="form-group col-xs-3">
                <label class="control-label">&nbsp;&nbsp;&nbsp;&nbsp;</label>
                <button type="button" class="btn btn-sm btn-primary col-xs-12" id="btn_tag"><i class="fa fa-tag"></i> Tag </button>
              </div> -->
              <div id="otherinfo">
              </div>
            </form>
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            ...
            <table class="cell-border compact hover width-full" id="dt_depende" cellspacing="0" width="100%">
              <thead>
                <tr>
                  <th>FULL NAME</th>
                  <th>DETAILS</th>

var   $dt_seniorperbrgy = $('#dt_seniorperbrgy'),
  ...
  $dt_soloparentperbrgy = $('#dt_soloparentperbrgy'),
  $dt_senioragegroup = $('#dt_senioragegroup'),
  $dt_civilstatus = $('#dt_civilstatus'),
  $dt_pwdperbrgy = $('#dt_pwdperbrgy'),
  $btn_scpressave = $('#btn_scpressave');
        ...
        var dt_soloparentperbrgy = $dt_soloparentperbrgy.DataTable({
          'ajax': {
            "type": "GET",
            "url": base_url + "report/get_brgysoloparentbygender",
            // "data": data,
            "dataSrc": ""
          },
          'columns': [
        ...
        var dt_civilstatus = $dt_civilstatus.DataTable({
          'ajax': {
            "type": "GET",
            "url": base_url + "report/get_count_by_civilstatus",
            // "data": data,
            "dataSrc": ""
          },
          'columns': [
...
function getTotalRecords(){
    ...
    getJSON(base_url + 'report/getTotal_sc').then(function(data) {
     if (data.status = "yes")
        $('#dt_seniorperbrgy_wrapper #dt_seniorperbrgy_info').html("<strong>"+data.content+" </strong> :Total Records");
        $('#dt_senioragegroup_wrapper #dt_senioragegroup_info').html("<strong>"+data.content+" </strong> :Total Records");
     }
   , function(status) {
     alert('Something went wrong.');
   });
    
    getJSON(base_url + 'report/get_countFernandinos').then(function(data) {
     if (data.status = "yes")
        $('#dt_civilstatus_wrapper #dt_civilstatus_info').html("<strong>"+data.content+"  </strong> :Total Records");
     }
   , function(status) {
     alert('Something went wrong.');
   });
    ...
    getJSON(base_url + 'report/get_countSoloParent').then(function(data) {
     if (data.status = "yes")
        $('#dt_soloparentperbrgy_wrapper #dt_soloparentperbrgy_info').html("<strong>"+data.content+"  </strong> :Total Records");
     }
   , function(status) {
     alert('Something went wrong.');
   });
        
    getJSON(base_url + 'report/get_countPwd').then(function(data) {
     if (data.status = "yes")
        $('#dt_pwdperbrgy_wrapper #dt_pwdperbrgy_info').html("<strong>"+data.content+" </strong> :Total Records");
     }
   , function(status) {
     alert('Something went wrong.');
   });
